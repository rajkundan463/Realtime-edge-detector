...
"C:\\Users\\Kundan Kumar\\AppData\\Local\\Android\\Sdk\\cmake\\3.22.1\\bin\\cmake.exe" ^
  ...
  "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY=D:\\Realtime-edge-detector\\openCV\\build\\intermediates\\cxx\\Debug\\4so482x6\\obj\\x86" ^
  "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=D:\\Realtime-edge-detector\\openCV\\build\\intermediates\\cxx\\Debug\\4so482x6\\obj\\x86" ^
  "-DCMAKE_BUILD_TYPE=Debug" ^
  "-BD:\\Realtime-edge-detector\\openCV\\.cxx\\Debug\\4so482x6\\x86" ^
  -GNinja ^
